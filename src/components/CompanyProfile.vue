        ...
        <div class="col-12 col-md-4">
          <q-card class="full-height">
            <q-card-section class="text-center">
              <q-avatar size="120px" class="q-mb-md shadow-3 company-logo-avatar">
                <img
      ...
      <q-dialog v-model="showWizard" persistent>
        <q-card style="min-width: 600px">
          <q-stepper v-model="step" ref="stepper" color="primary" animated header-nav>
            ...
            <q-step :name="3" title="Branding & Socials" icon="palette">
              <q-file
...
const company = ref({
  ...
  about:
    "Innovate Inc. is a leading tech company focusing on smart AI solutions for a better future. We thrive on creativity and collaboration.",
  logoUrl: null,
...
/* Ensure logo is perfectly circular */
